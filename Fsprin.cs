...
{
    public partial class Fsprin : Form
    {
        public Fsprin()
        {
            InitializeComponent();
        ...
        private void Fsprin_Load(object sender, EventArgs e)
        {

            SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-CH3OF0Q;Initial Catalog=UMS;Integrated Security=True");
            conn.Open();
            string query = "select * from TsfS";
            ...
            conn.Open();
            string query1 = "select * from student_infoS";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-CH3OF0Q;Initial Catalog=UMS;Integrated Security=True");
                conn.Open();
                string query = "select * from TsfS where No=" + No;
                DataTable dt = LoadDatabase(query);
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-CH3OF0Q;Initial Catalog=UMS;Integrated Security=True");
                conn.Open();
                string query1 = "select * from student_infoS where ID=" + ID;
                DataTable dt1 = LoadDatabase1(query1);
