...
{
    public partial class fallF : Form
    {
        public fallF()
        {
            InitializeComponent();
        ...
        private void fallF_Load(object sender, EventArgs e)
        {
            SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-CH3OF0Q;Initial Catalog=UMS;Integrated Security=True");
            conn.Open();
            string query = "select * from TsfF";
            ...
            conn.Open();
            string query1 = "select * from student_infof";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-CH3OF0Q;Initial Catalog=UMS;Integrated Security=True");
                conn.Open();
                string query = "select * from TsfF where No=" + No;
                DataTable dt = LoadDatabase(query);
        ...
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-CH3OF0Q;Initial Catalog=UMS;Integrated Security=True");
                conn.Open();
                string query1 = "select * from student_infof where ID=" + ID;
                DataTable dt1 = LoadDatabase1(query1);
                textBox4.Text = dt1.Rows[0]["ID"].ToString();
                textBox5.Text = dt1.Rows[0]["Name"].ToString();
                textBox6.Text = dt1.Rows[0]["CGPA"].ToString();
